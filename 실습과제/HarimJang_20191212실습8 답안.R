...
buildDictionary( ext_dic = "woorimalsam" )      # 사전 사용하는 방법 1 ( 외부사전 사용)
noun <- sapply( text, extractNoun, USE.NAMES = F )    # 클라우드 하기 전 꼭 명사의 빈도수를 확인해야한다. 
noun 
...
# ex_10-2.txt
useSejongDic()                                 # 사전 사용하는 방법 2 ( 내부사전 사용 )
